    ...
    return (
      <main className="min-h-screen w-full flex flex-col justify-center items-center px-4 py-8 bg-paper">
        <div className="w-full max-w-[440px] bg-surface rounded-2xl border border-hairline p-7 sm:p-9 text-center space-y-4 shadow-sm">
          <div className="w-12 h-12 rounded-2xl border border-clay/20 bg-clay-tint flex items-center justify-center mx-auto text-clay">
          ...
          <Link
            to="/forgot-password"
            className="w-full h-11 rounded-xl border border-moss bg-moss hover:bg-moss-deep text-white font-medium text-[14px] shadow-sm transition-all flex items-center justify-center"
          >
