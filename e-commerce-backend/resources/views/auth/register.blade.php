...
<body class="w-screen h-screen flex justify-between items-center">
    <div class="relative h-full w-1/2 flex flex-col items-center justify-center gap-2.5">
        ...
        <!-- <div class="absolute w-4/5 top-10 z-10 flex flex-col justify-center gap-2 px-5">
            <h1 class="uppercase text-4xl tracking-tighter font-semibold text-black text-balance">Make your skin glower and easy life.</h1>
            <p class="text-base">The only way to make you skin glower and easier life style.</p>
        </div> -->
    ...
    <div class=" h-full w-1/2 flex flex-col justify-center gap-2.5 px-12">
        <form class="w-full flex flex-col gap-2.5" action="#" method="post">
            <div class="w-full flex flex-col justify-center gap-1.5">
                <label class="cursor-pointer text-sm text-black" for="fullname">Full Name <span class="text-red-500">*</span></label>
                <input class="h-12 px-4 bg-[var(--gray)] rounded-full text-sm border border-transparent outline-0 transition duration-200 hover:border-black focus:border-black" type="text" id="fullname" name="fullname" placeholder="Pisal Mony">
            </div>
            <div class="w-full flex flex-col justify-center gap-1.5">
            ...
            <div class="w-full flex flex-col justify-center gap-1.5">
                <label class="cursor-pointer text-sm text-black" for="password">Create password <span class="text-red-500">*</span></label>
            ...
            <div class="w-full flex flex-col justify-center gap-1.5">
                <label class="cursor-pointer text-sm text-black" for="confirm_password">Confirm password <span class="text-red-500">*</span></label>
                <input class="h-12 px-4 bg-[var(--gray)] rounded-full text-sm border border-transparent outline-0 transition duration-200 hover:border-black focus:border-black" type="password" id="confirm_password" name="confirm_password" placeholder="Confirm password">
            </div>
        ...
        <div class="w-full flex justify-center items-center">
            <p class="text-sm text-black">Already have an account ? <a class=" font-semibold" href="{{ route('login') }}">Login</a></p>
        </div>
    </div>
</body>
